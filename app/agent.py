...
class HROnboardingAgent:
    ...
    def _build_graph(self):
        ...
        workflow.add_conditional_edges(
            ...
            {"rh": "retriever", "out_of_scope": "fallback"},
        )
    ...
    def _route_after_classification(self, state: AgentState) -> Literal["rh", "out_of_scope"]:
...
Use APENAS as informacoes dos documentos abaixo para responder a pergunta do usuario.
Se a informacao nao estiver nos documentos, diga que nao encontrou e sugira contatar o RH.

Sempre mencione de qual documento veio a informacao no final da sua resposta.
Se usou mais de um documento, cite todos.
...
Pergunta do usuario: {question}"""
        ...
        print(f"[FALLBACK] Resposta generica gerada")
